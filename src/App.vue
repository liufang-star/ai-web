                      ...
                      <div class="md:flex items-start text-center gap-3.5">
                        <div class="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                          ...
                          <ul class="flex flex-col gap-3.5 w-full sm:max-w-md m-auto">
                            <button @click="inputChat('百济神州有哪些产品')"
                              class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-gray-200 dark:hover:bg-gray-900">
                              "百济神州有哪些产品" →
                            </button>
                            <button @click="inputChat('百济神州的研发能力如何')"
                              class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-gray-200 dark:hover:bg-gray-900">
                              "百济神州的研发能力如何" →
                            </button>
                            <button @click="inputChat('百济神州的价值观')"
                              class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md hover:bg-gray-200 dark:hover:bg-gray-900">
                              "百济神州的价值观" →
                            </button>
                          </ul>
                        ...
                        <div class="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                          ...
                          <ul class="flex flex-col gap-3.5 w-full sm:max-w-md m-auto">
                            ...
                            <li class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">允许用户提供后续更正
                            </li>
                            <li class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">接受过拒绝不当请求的培训
                            </li>
                          </ul>
                        </div>
                        <div class="flex flex-col mb-8 md:mb-auto gap-3.5 flex-1">
                          ...
                          <ul class="flex flex-col gap-3.5 w-full sm:max-w-md m-auto">
                            <li class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">可能偶尔生成不正确的信息
                            </li>
                            <li class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">可能偶尔产生有偏见的内容
                            </li>
                            <li class="w-full bg-gray-50 dark:bg-white/5 p-3 rounded-md">对2021年后的事件了解有限
                            </li>
                          </ul>
                        </div>
                      </div>
              ...
              <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                ...
                <div v-if="popupShow"
                  ...
                  <div class="prose dark:prose-invert">
                    ...
                    <h4 class="mb-4">
                      项目基于openai开放api开发，使用的是davinci模型.</h4>
                    <div class="flex gap-4 flex-col text-sm">
                      <div class="flex p-4 bg-gray-50 dark:bg-white/5 rounded-md items-center gap-4 min-h-[71px]">
                        ...
                        <div class="flex-1 leading-5">
                          后端使用python flask技术作为交互的桥梁
                        </div>
                      </div>
                      <div class="flex p-4 bg-gray-50 dark:bg-white/5 rounded-md items-center gap-4 min-h-[71px]">
                        <div class="w-10 text-2xl text-center">🔬</div>
                        <div class="flex-1 leading-5">前端使用vue高仿Chatgpt图形界面
                        </div>
                      </div>
                    </div>
                    <div class="flex gap-4 mt-6">
                      <button @click="closePopup" class="btn flex justify-center gap-2 btn-primary ml-auto">关闭
                      </button>
                    </div>
                  </div>
